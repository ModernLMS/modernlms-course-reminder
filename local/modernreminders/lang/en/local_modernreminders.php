...
$string['reminderdays'] = 'Days After Enrolment';
$string['reminderdays_help'] = 'The number of days after enrolment by which the user is expected to complete the course. If the course is not completed within this period, the system will begin sending reminder emails.';
$string['reminderdays_unit'] = 'Days';
$string['emailfrequency'] = 'Email Frequency';
$string['emailfrequency_help'] = 'How often to repeat reminder emails until the user completes the course. Daily sends a reminder every day, Weekly every 7 days, and Monthly every 30 days.';
...
$string['remindertoosoon'] = 'Last reminder to user {$a->userid} for course {$a->courseid} was {$a->daysago} days ago. Next reminder due in {$a->daysleft} days. Skipping.';
